...
import type { PersonalViewData } from "@/lib/sugar-types";
...
export default function PersonalView({ data }: Props) {
    ...
    >
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-lg border border-zinc-800/70 bg-zinc-950/70 p-4">
          ...
          <p className="text-sm leading-relaxed text-white/80">{data.sizingLogic}</p>
        </div>
      </div>
